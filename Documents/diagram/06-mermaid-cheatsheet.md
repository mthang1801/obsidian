...
| Aspect | Detail |
| --- | --- |
| **Concept** | Legacy bridge for `Mermaid Cheatsheet` |
...
You are writing technical docs and want diagrams that live alongside markdown, reviewable via git diff, but you keep forgetting the syntax every time you need to redraw. The Mermaid cheatsheet exists for exactly that moment: less friction, steady writing rhythm, no tool-switching mid-flow.
...
| New file | Role |
| --- | --- |
| [Mermaid Cheatsheet](08-reference/01-mermaid-cheatsheet.md) | Current canonical article for this topic |
...
```mermaid
flowchart LR
Question[What do you need?] --> Flow[flowchart]
Question --> Sequence[sequenceDiagram]
Question --> State[stateDiagram-v2]
Question --> Plan[gantt / gitGraph]
```
...
> **Example**: `Mermaid Cheatsheet` has been regrouped into the appropriate subfolder.
> **Complexity**: Basic

```yaml
bridge_doc:
  old_path: 06-mermaid-cheatsheet.md
  canonical_path: 08-reference/01-mermaid-cheatsheet.md
...
| --- | --- | --- | --- |
| Mermaid docs | Official docs | https://mermaid.js.org/ | Canonical landing page |
| Mermaid syntax reference | Official docs | https://mermaid.js.org/intro/syntax-reference.html | Full syntax index |
...
| --- | --- | --- | --- |
| Mermaid Cheatsheet | When you need canonical content, examples, and real pitfalls | The canonical article is maintained under the new workflow | [Mermaid Cheatsheet](08-reference/01-mermaid-cheatsheet.md) |
