<!-- tags: java, expert -->
# Java Expert Topics Resilience

> Điểm vào cho nhánh Java Expert Topics Resilience, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java Expert Topics Resilience`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-timeouts-retries-circuit-breaker-mindset.md`](01-timeouts-retries-circuit-breaker-mindset.md) | Article | Seed article của nhánh hiện tại |
...
----------------------------  ----------------------------  ----------------
Java Expert — Timeouts, Retr  entry article                  1 article
```
...
| --- | --- | --- |
| [`01-timeouts-retries-circuit-breaker-mindset.md`](./01-timeouts-retries-circuit-breaker-mindset.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
