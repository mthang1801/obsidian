<!-- tags: java, expert -->
# Java Expert Topics Observability

> Điểm vào cho nhánh Java Expert Topics Observability, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java Expert Topics Observability`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-metrics-logs-trace-correlation.md`](01-metrics-logs-trace-correlation.md) | Article | Seed article của nhánh hiện tại |
...
----------------------------  ----------------------------  ----------------
Java Expert — Metrics, Logs   entry article                  1 article
```
...
| --- | --- | --- |
| [`01-metrics-logs-trace-correlation.md`](./01-metrics-logs-trace-correlation.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
