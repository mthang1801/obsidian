...
> Lane này viết về lock như công cụ giữ invariant, không như phản diện của hiệu năng.

📅 Ngày tạo: 2026-03-27 · 🔄 Cập nhật: 2026-04-04 · ⏱️ 5 phút đọc

## 1. DEFINE

Hình dung bạn đã thử concurrent collection, đã thử queue, nhưng vẫn còn một invariant nhiều bước không thể giữ chỉ bằng may mắn. Lúc đó lock không còn là thứ nên né. Nó là cách thừa nhận rằng shared state cần một biên phối hợp rõ ràng.

Lane `Java Concurrency Locks` được mở để biến một đường link từng chết thành một decision point có thể dùng thật trong reading path của `assets/java`.
...
| [`../concurrent-collections/README.md`](../concurrent-collections/README.md) | Khi lane này chưa đủ để mở hết tension | Giữ người đọc ở cùng cụm thay vì nhảy ngẫu nhiên |
