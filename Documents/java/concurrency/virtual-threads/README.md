...
> Điểm vào cho nhánh Java Concurrency Virtual Threads, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java Concurrency Virtual Threads`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-virtual-threads-for-io-bound-workloads.md`](01-virtual-threads-for-io-bound-workloads.md) | Article | Seed article của nhánh hiện tại |
...
----------------------------  ----------------------------  ----------------
Java Concurrency — Virtual T  entry article                  1 article
```
...
| --- | --- | --- |
| [`01-virtual-threads-for-io-bound-workloads.md`](./01-virtual-threads-for-io-bound-workloads.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
