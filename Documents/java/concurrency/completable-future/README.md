...
> Điểm vào cho nhánh Java Concurrency Completable Future, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java Concurrency Completable Future`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-async-composition-with-completablefuture.md`](01-async-composition-with-completablefuture.md) | Article | Seed article của nhánh hiện tại |
...
----------------------------  ----------------------------  ----------------
Java Concurrency — Async Com  entry article                  1 article
```
...
| --- | --- | --- |
| [`01-async-composition-with-completablefuture.md`](./01-async-composition-with-completablefuture.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
