...
# Java Architecture Hexagonal

> Điểm vào cho nhánh Java Architecture Hexagonal, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java Architecture Hexagonal`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-ports-adapters-service-boundaries.md`](01-ports-adapters-service-boundaries.md) | Article | Seed article của nhánh hiện tại |
...
----------------------------  ----------------------------  ----------------
Java Architecture — Ports, A  entry article                  1 article
```
...
| --- | --- | --- |
| [`01-ports-adapters-service-boundaries.md`](./01-ports-adapters-service-boundaries.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
