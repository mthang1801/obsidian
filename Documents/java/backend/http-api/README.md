<!-- tags: java, backend -->
# Java Backend HTTP API

> Điểm vào cho nhánh Java Backend HTTP API, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java Backend HTTP API`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-rest-api-validation-error-contracts.md`](01-rest-api-validation-error-contracts.md) | Article | Seed article của nhánh hiện tại |
...
----------------------------  ----------------------------  ----------------
Java Backend — REST API, Val  entry article                  1 article
```
...
| --- | --- | --- |
| [`01-rest-api-validation-error-contracts.md`](./01-rest-api-validation-error-contracts.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
