...
> Router cho nhánh Java Backend, nơi Caching, HTTP API, Messaging và các lane liên quan được ghép thành một đường học có chủ đích.
...
Riêng với nhánh `Java Backend`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`caching/`](caching/README.md) | Directory | Router cho nhánh Caching |
| [`http-api/`](http-api/README.md) | Directory | Router cho nhánh HTTP API |
| [`messaging/`](messaging/README.md) | Directory | Router cho nhánh Messaging |
| [`persistence/`](persistence/README.md) | Directory | Router cho nhánh Persistence |
| [`transactions/`](transactions/README.md) | Directory | Router cho nhánh Transactions |
| [`validation/`](validation/README.md) | Directory | Router cho nhánh Validation |
...
```text
Caching -> HTTP API -> Messaging -> Persistence -> Transactions -> Validation
```
...
----------------------------  ----------------------------  ----------------
Caching                       entry via README               0 article(s)
HTTP API                      entry via README               1 article(s)
Messaging                     entry via README               0 article(s)
Persistence                   entry via README               0 article(s)
Transactions                  entry via README               1 article(s)
Validation                    entry via README               0 article(s)
```
...
| --- | --- | --- |
| [`caching/`](./caching/README.md) | Khi muốn đi sâu vào Caching | Giữ learning path liền mạch |
| [`http-api/`](./http-api/README.md) | Khi muốn đi sâu vào HTTP API | Giữ learning path liền mạch |
| [`messaging/`](./messaging/README.md) | Khi muốn đi sâu vào Messaging | Giữ learning path liền mạch |
| [`persistence/`](./persistence/README.md) | Khi muốn đi sâu vào Persistence | Giữ learning path liền mạch |
| [`transactions/`](./transactions/README.md) | Khi muốn đi sâu vào Transactions | Giữ learning path liền mạch |
| [`validation/`](./validation/README.md) | Khi muốn đi sâu vào Validation | Giữ learning path liền mạch |
