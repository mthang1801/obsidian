...
> Điểm vào cho nhánh Java Fundamentals Collections, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java Fundamentals Collections`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-list-set-map.md`](01-list-set-map.md) | Article | Seed article của nhánh hiện tại |
...
----------------------------  ----------------------------  ----------------
Java Collections — List, Set  entry article                  1 article
```
...
| --- | --- | --- |
| [`01-list-set-map.md`](./01-list-set-map.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
