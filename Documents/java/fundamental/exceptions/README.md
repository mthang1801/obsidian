...
> Lane này đặt exception về đúng vai trò giao tiếp giữa các boundary, không chỉ là cách dập lỗi cho khỏi nổ.

📅 Ngày tạo: 2026-03-27 · 🔄 Cập nhật: 2026-04-04 · ⏱️ 5 phút đọc

## 1. DEFINE

Hình dung một lỗi hạ tầng bị ném thẳng lên web layer, một business exception bị bọc mất cause, và cả team không còn chắc boundary nào phải nói ngôn ngữ gì khi failure xảy ra. Exception handling chỉ thật sự quan trọng ở chính khoảnh khắc đó.

Lane `Java Fundamentals Exceptions` được mở để biến một đường link từng chết thành một decision point có thể dùng thật trong reading path của `assets/java`.
...
| [`../generics/README.md`](../generics/README.md) | Khi lane này chưa đủ để mở hết tension | Giữ người đọc ở cùng cụm thay vì nhảy ngẫu nhiên |
