...
> Điểm vào cho nhánh Java Fundamentals Basics, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java Fundamentals Basics`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-syntax-control-flow.md`](01-syntax-control-flow.md) | Article | Seed article của nhánh hiện tại |
| [`02-classes-records-enums.md`](02-classes-records-enums.md) | Article | Seed article của nhánh hiện tại |
...
```text
Java Basics — Syntax & Control Flow -> Java Basics — Classes, Records & Enums
```
...
----------------------------  ----------------------------  ----------------
Java Basics — Syntax & Contr  entry article                  1 article
Java Basics — Classes, Recor  entry article                  1 article
```
...
| --- | --- | --- |
| [`01-syntax-control-flow.md`](./01-syntax-control-flow.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
| [`02-classes-records-enums.md`](./02-classes-records-enums.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
