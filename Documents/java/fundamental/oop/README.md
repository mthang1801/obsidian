...
> Lane này kéo OOP khỏi giáo trình và đặt lại vào nơi nó làm đau codebase thật: state, behavior, boundary.

📅 Ngày tạo: 2026-03-27 · 🔄 Cập nhật: 2026-04-04 · ⏱️ 5 phút đọc

## 1. DEFINE

Hình dung một class nhìn rất sạch với đầy getter/setter, nhưng mọi business rule lại trôi hết ra ngoài. Hoặc một hierarchy ban đầu tiện tay, vài tháng sau đã thành cái lồng khóa chặt mọi thay đổi. OOP chỉ đáng học ở đúng lúc state và behavior bắt đầu đi lạc khỏi nhau.

Lane `Java Fundamentals OOP` được mở để biến một đường link từng chết thành một decision point có thể dùng thật trong reading path của `assets/java`.
...
| [`../collections/README.md`](../collections/README.md) | Khi lane này chưa đủ để mở hết tension | Giữ người đọc ở cùng cụm thay vì nhảy ngẫu nhiên |
| [`../exceptions/README.md`](../exceptions/README.md) | Khi lane này chưa đủ để mở hết tension | Giữ người đọc ở cùng cụm thay vì nhảy ngẫu nhiên |
