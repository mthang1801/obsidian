...
> Lane này nhìn class loading như runtime boundary giữa code bạn viết và code JVM thực sự thấy.

📅 Ngày tạo: 2026-03-27 · 🔄 Cập nhật: 2026-04-04 · ⏱️ 5 phút đọc

## 1. DEFINE

Hình dung ứng dụng build xanh hoàn toàn, nhưng lên môi trường thật lại nổ `ClassNotFoundException` đúng ở chỗ framework phản xạ class bằng tên. Class loading chỉ trở nên đáng học khi compile-time certainty bắt đầu không còn đủ để bảo vệ runtime nữa.

Lane `Java JVM Class Loading` được mở để biến một đường link từng chết thành một decision point có thể dùng thật trong reading path của `assets/java`.
...
| --- | --- | --- |
| [`../gc/README.md`](../gc/README.md) | Khi lane này chưa đủ để mở hết tension | Giữ người đọc ở cùng cụm thay vì nhảy ngẫu nhiên |
| [`../jit/README.md`](../jit/README.md) | Khi lane này chưa đủ để mở hết tension | Giữ người đọc ở cùng cụm thay vì nhảy ngẫu nhiên |
| [`../memory-model/README.md`](../memory-model/README.md) | Khi lane này chưa đủ để mở hết tension | Giữ người đọc ở cùng cụm thay vì nhảy ngẫu nhiên |
