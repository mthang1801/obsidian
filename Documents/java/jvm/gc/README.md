...
> Điểm vào cho nhánh Java JVM Garbage Collection, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java JVM Garbage Collection`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-garbage-collection-basics-tuning-mindset.md`](01-garbage-collection-basics-tuning-mindset.md) | Article | Seed article của nhánh hiện tại |
...
----------------------------  ----------------------------  ----------------
JVM Internals — Garbage Coll  entry article                  1 article
```
...
| --- | --- | --- |
| [`01-garbage-collection-basics-tuning-mindset.md`](./01-garbage-collection-basics-tuning-mindset.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
