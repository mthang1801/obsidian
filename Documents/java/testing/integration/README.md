...
> Điểm vào cho nhánh Java Testing Integration Testing, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java Testing Integration Testing`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-spring-test-slices-vs-full-context.md`](01-spring-test-slices-vs-full-context.md) | Article | Seed article của nhánh hiện tại |
...
----------------------------  ----------------------------  ----------------
Java Testing — Spring Test S  entry article                  1 article
```
...
| --- | --- | --- |
| [`01-spring-test-slices-vs-full-context.md`](./01-spring-test-slices-vs-full-context.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
