...
> Điểm vào cho nhánh Java Testing JUnit 5, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java Testing JUnit 5`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-junit5-essentials.md`](01-junit5-essentials.md) | Article | Seed article của nhánh hiện tại |
...
----------------------------  ----------------------------  ----------------
Java Testing — JUnit 5 Essen  entry article                  1 article
```
...
| --- | --- | --- |
| [`01-junit5-essentials.md`](./01-junit5-essentials.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
