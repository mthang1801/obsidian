...
> Điểm vào cho nhánh Java Testing Mockito, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java Testing Mockito`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-mockito-basics-service-tests.md`](01-mockito-basics-service-tests.md) | Article | Seed article của nhánh hiện tại |
...
----------------------------  ----------------------------  ----------------
Java Testing — Mockito Basic  entry article                  1 article
```
...
| --- | --- | --- |
| [`01-mockito-basics-service-tests.md`](./01-mockito-basics-service-tests.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
