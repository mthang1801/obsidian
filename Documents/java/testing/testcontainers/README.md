...
> Điểm vào cho nhánh Java Testing Testcontainers, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java Testing Testcontainers`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-real-dependencies-with-testcontainers.md`](01-real-dependencies-with-testcontainers.md) | Article | Seed article của nhánh hiện tại |
...
----------------------------  ----------------------------  ----------------
Java Testing — Real Dependen  entry article                  1 article
```
...
| --- | --- | --- |
| [`01-real-dependencies-with-testcontainers.md`](./01-real-dependencies-with-testcontainers.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
