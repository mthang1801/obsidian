...
> Router cho nhánh Java Quiz, nơi Module Quiz, Scenario Quiz và các lane liên quan được ghép thành một đường học có chủ đích.
...
Riêng với nhánh `Java Quiz`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`module/`](module/README.md) | Directory | Router cho nhánh Module Quiz |
| [`scenario/`](scenario/README.md) | Directory | Router cho nhánh Scenario Quiz |
...
----------------------------  ----------------------------  ----------------
Module Quiz                   entry via README               3 article(s)
Scenario Quiz                 entry via README               1 article(s)
```
...
| --- | --- | --- |
| [`module/`](./module/README.md) | Khi muốn đi sâu vào Module Quiz | Giữ learning path liền mạch |
| [`scenario/`](./scenario/README.md) | Khi muốn đi sâu vào Scenario Quiz | Giữ learning path liền mạch |
