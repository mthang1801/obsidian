<!-- tags: java, quiz -->
# Java Quiz Scenario Quiz

> Điểm vào cho nhánh Java Quiz Scenario Quiz, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java Quiz Scenario Quiz`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-on-call-triage-for-java-services.md`](01-on-call-triage-for-java-services.md) | Article | Seed article của nhánh hiện tại |
...
----------------------------  ----------------------------  ----------------
Java Scenario Quiz — On-Call  entry article                  1 article
```
...
| --- | --- | --- |
| [`01-on-call-triage-for-java-services.md`](./01-on-call-triage-for-java-services.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
