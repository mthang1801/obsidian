...
# Java Frameworks Spring Security

> Router cho nhánh Java Frameworks Spring Security, nơi Basics, JWT, OAuth2 và các lane liên quan được ghép thành một đường học có chủ đích.
...
Riêng với nhánh `Java Frameworks Spring Security`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| [`jwt/`](jwt/README.md) | Directory | Router cho nhánh JWT |
| [`oauth2/`](oauth2/README.md) | Directory | Router cho nhánh OAuth2 |
...
JWT                           entry via README               1 article(s)
OAuth2                        entry via README               1 article(s)
```
...
| [`jwt/`](./jwt/README.md) | Khi muốn đi sâu vào JWT | Giữ learning path liền mạch |
| [`oauth2/`](./oauth2/README.md) | Khi muốn đi sâu vào OAuth2 | Giữ learning path liền mạch |
