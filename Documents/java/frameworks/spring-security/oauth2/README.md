...
# Java Frameworks Spring Security OAuth2

> Điểm vào cho nhánh Java Frameworks Spring Security OAuth2, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java Frameworks Spring Security OAuth2`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-oauth2-login-sso-mental-model.md`](01-oauth2-login-sso-mental-model.md) | Article | Seed article của nhánh hiện tại |
...
----------------------------  ----------------------------  ----------------
Spring Security — OAuth2 Log  entry article                  1 article
```
...
| --- | --- | --- |
| [`01-oauth2-login-sso-mental-model.md`](./01-oauth2-login-sso-mental-model.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
