...
# Java Frameworks Spring Data Queries

> Điểm vào cho nhánh Java Frameworks Spring Data Queries, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java Frameworks Spring Data Queries`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-derived-queries-projections-custom-jpql.md`](01-derived-queries-projections-custom-jpql.md) | Article | Seed article của nhánh hiện tại |
...
----------------------------  ----------------------------  ----------------
Spring Data — Derived Querie  entry article                  1 article
```
...
| --- | --- | --- |
| [`01-derived-queries-projections-custom-jpql.md`](./01-derived-queries-projections-custom-jpql.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
