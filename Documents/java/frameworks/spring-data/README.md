...
# Java Frameworks Spring Data

> Router cho nhánh Java Frameworks Spring Data, nơi JPA, Queries, Repositories và các lane liên quan được ghép thành một đường học có chủ đích.
...
Riêng với nhánh `Java Frameworks Spring Data`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`jpa/`](jpa/README.md) | Directory | Router cho nhánh JPA |
| [`queries/`](queries/README.md) | Directory | Router cho nhánh Queries |
| [`repositories/`](repositories/README.md) | Directory | Router cho nhánh Repositories |
...
----------------------------  ----------------------------  ----------------
JPA                           entry via README               1 article(s)
Queries                       entry via README               1 article(s)
Repositories                  entry via README               0 article(s)
```
...
| --- | --- | --- |
| [`jpa/`](./jpa/README.md) | Khi muốn đi sâu vào JPA | Giữ learning path liền mạch |
| [`queries/`](./queries/README.md) | Khi muốn đi sâu vào Queries | Giữ learning path liền mạch |
| [`repositories/`](./repositories/README.md) | Khi muốn đi sâu vào Repositories | Giữ learning path liền mạch |
