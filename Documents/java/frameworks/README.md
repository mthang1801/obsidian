...
> Router cho nhánh Java Frameworks, nơi Spring Framework, Spring Boot, Spring Data và các lane liên quan được ghép thành một đường học có chủ đích.
...
Riêng với nhánh `Java Frameworks`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`spring/`](spring/README.md) | Directory | Router cho nhánh Spring Framework |
| [`spring-boot/`](spring-boot/README.md) | Directory | Router cho nhánh Spring Boot |
| [`spring-data/`](spring-data/README.md) | Directory | Router cho nhánh Spring Data |
| [`spring-security/`](spring-security/README.md) | Directory | Router cho nhánh Spring Security |
...
----------------------------  ----------------------------  ----------------
Spring Framework              entry via README               3 article(s)
Spring Boot                   entry via README               5 article(s)
Spring Data                   entry via README               2 article(s)
Spring Security               entry via README               3 article(s)
```
...
| --- | --- | --- |
| [`spring/`](./spring/README.md) | Khi muốn đi sâu vào Spring Framework | Giữ learning path liền mạch |
| [`spring-boot/`](./spring-boot/README.md) | Khi muốn đi sâu vào Spring Boot | Giữ learning path liền mạch |
| [`spring-data/`](./spring-data/README.md) | Khi muốn đi sâu vào Spring Data | Giữ learning path liền mạch |
| [`spring-security/`](./spring-security/README.md) | Khi muốn đi sâu vào Spring Security | Giữ learning path liền mạch |
