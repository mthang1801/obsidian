...
# Java Frameworks Spring Boot Deployment

> Điểm vào cho nhánh Java Frameworks Spring Boot Deployment, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java Frameworks Spring Boot Deployment`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-packaging-containers-runtime-tuning.md`](01-packaging-containers-runtime-tuning.md) | Article | Seed article của nhánh hiện tại |
...
----------------------------  ----------------------------  ----------------
Spring Boot Deployment — Pac  entry article                  1 article
```
...
| --- | --- | --- |
| [`01-packaging-containers-runtime-tuning.md`](./01-packaging-containers-runtime-tuning.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
