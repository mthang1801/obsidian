...
# Java Frameworks Spring Boot Basics

> Điểm vào cho nhánh Java Frameworks Spring Boot Basics, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java Frameworks Spring Boot Basics`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-bootstrap-project-structure.md`](01-bootstrap-project-structure.md) | Article | Seed article của nhánh hiện tại |
...
----------------------------  ----------------------------  ----------------
Spring Boot Basics — Bootstr  entry article                  1 article
```
...
| --- | --- | --- |
| [`01-bootstrap-project-structure.md`](./01-bootstrap-project-structure.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
