...
> Router cho nhánh Java Frameworks Spring Boot, nơi Actuator, Basics, Configuration và các lane liên quan được ghép thành một đường học có chủ đích.
...
Riêng với nhánh `Java Frameworks Spring Boot`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`actuator/`](actuator/README.md) | Directory | Router cho nhánh Actuator |
| [`basics/`](basics/README.md) | Directory | Router cho nhánh Basics |
| [`config/`](config/README.md) | Directory | Router cho nhánh Configuration |
| [`deployment/`](deployment/README.md) | Directory | Router cho nhánh Deployment |
| [`web/`](web/README.md) | Directory | Router cho nhánh Web |
...
```text
Actuator -> Basics -> Configuration -> Deployment -> Web
```
...
----------------------------  ----------------------------  ----------------
Actuator                      entry via README               1 article(s)
Basics                        entry via README               1 article(s)
Configuration                 entry via README               1 article(s)
Deployment                    entry via README               1 article(s)
Web                           entry via README               1 article(s)
```
...
| --- | --- | --- |
| [`actuator/`](./actuator/README.md) | Khi muốn đi sâu vào Actuator | Giữ learning path liền mạch |
| [`basics/`](./basics/README.md) | Khi muốn đi sâu vào Basics | Giữ learning path liền mạch |
| [`config/`](./config/README.md) | Khi muốn đi sâu vào Configuration | Giữ learning path liền mạch |
| [`deployment/`](./deployment/README.md) | Khi muốn đi sâu vào Deployment | Giữ learning path liền mạch |
| [`web/`](./web/README.md) | Khi muốn đi sâu vào Web | Giữ learning path liền mạch |
