...
> Router cho nhánh Java Frameworks Spring Framework, nơi Beans, Core, Mvc và các lane liên quan được ghép thành một đường học có chủ đích.
...
Riêng với nhánh `Java Frameworks Spring Framework`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`beans/`](beans/README.md) | Directory | Router cho nhánh Beans |
| [`core/`](core/README.md) | Directory | Router cho nhánh Core |
| [`mvc/`](mvc/README.md) | Directory | Router cho nhánh Mvc |
...
----------------------------  ----------------------------  ----------------
Beans                         entry via README               1 article(s)
Core                          entry via README               1 article(s)
Mvc                           entry via README               1 article(s)
```
...
| --- | --- | --- |
| [`beans/`](./beans/README.md) | Khi muốn đi sâu vào Beans | Giữ learning path liền mạch |
| [`core/`](./core/README.md) | Khi muốn đi sâu vào Core | Giữ learning path liền mạch |
| [`mvc/`](./mvc/README.md) | Khi muốn đi sâu vào Mvc | Giữ learning path liền mạch |
