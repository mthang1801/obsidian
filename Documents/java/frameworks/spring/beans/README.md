...
# Java Frameworks Spring Framework Beans

> Điểm vào cho nhánh Java Frameworks Spring Framework Beans, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java Frameworks Spring Framework Beans`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-bean-lifecycle-scopes-java-config.md`](01-bean-lifecycle-scopes-java-config.md) | Article | Seed article của nhánh hiện tại |
...
----------------------------  ----------------------------  ----------------
Spring Beans — Lifecycle, Sc  entry article                  1 article
```
...
| --- | --- | --- |
| [`01-bean-lifecycle-scopes-java-config.md`](./01-bean-lifecycle-scopes-java-config.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
