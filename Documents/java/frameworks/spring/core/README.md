...
# Java Frameworks Spring Framework Core

> Điểm vào cho nhánh Java Frameworks Spring Framework Core, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java Frameworks Spring Framework Core`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-applicationcontext-dependency-injection.md`](01-applicationcontext-dependency-injection.md) | Article | Seed article của nhánh hiện tại |
...
----------------------------  ----------------------------  ----------------
Spring Core — ApplicationCon  entry article                  1 article
```
...
| --- | --- | --- |
| [`01-applicationcontext-dependency-injection.md`](./01-applicationcontext-dependency-injection.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
