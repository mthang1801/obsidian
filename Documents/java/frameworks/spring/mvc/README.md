...
# Java Frameworks Spring Framework Mvc

> Điểm vào cho nhánh Java Frameworks Spring Framework Mvc, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java Frameworks Spring Framework Mvc`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-dispatcher-servlet-controller-flow.md`](01-dispatcher-servlet-controller-flow.md) | Article | Seed article của nhánh hiện tại |
...
----------------------------  ----------------------------  ----------------
Spring MVC — DispatcherServl  entry article                  1 article
```
...
| --- | --- | --- |
| [`01-dispatcher-servlet-controller-flow.md`](./01-dispatcher-servlet-controller-flow.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
