...
> Điểm vào cho nhánh Java Performance Profiling, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java Performance Profiling`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-profiling-hotspots-before-tuning.md`](01-profiling-hotspots-before-tuning.md) | Article | Seed article của nhánh hiện tại |
...
----------------------------  ----------------------------  ----------------
Java Performance — Profiling  entry article                  1 article
```
...
| --- | --- | --- |
| [`01-profiling-hotspots-before-tuning.md`](./01-profiling-hotspots-before-tuning.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
