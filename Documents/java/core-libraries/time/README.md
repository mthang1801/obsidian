...
# Java Core Libraries Time API

> Điểm vào cho nhánh Java Core Libraries Time API, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java Core Libraries Time API`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-instant-localdatetime-zoneid-duration.md`](01-instant-localdatetime-zoneid-duration.md) | Article | Seed article của nhánh hiện tại |
...
----------------------------  ----------------------------  ----------------
Java Core Libraries — Instan  entry article                  1 article
```
...
| --- | --- | --- |
| [`01-instant-localdatetime-zoneid-duration.md`](./01-instant-localdatetime-zoneid-duration.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
