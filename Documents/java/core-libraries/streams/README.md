...
# Java Core Libraries Streams

> Điểm vào cho nhánh Java Core Libraries Streams, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java Core Libraries Streams`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-map-filter-collect-stream-pitfalls.md`](01-map-filter-collect-stream-pitfalls.md) | Article | Seed article của nhánh hiện tại |
...
----------------------------  ----------------------------  ----------------
Java Core Libraries — Map, F  entry article                  1 article
```
...
| --- | --- | --- |
| [`01-map-filter-collect-stream-pitfalls.md`](./01-map-filter-collect-stream-pitfalls.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
