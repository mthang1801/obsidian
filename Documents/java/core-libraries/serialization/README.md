...
# Java Core Libraries Serialization

> Lane này nhìn serialization như nơi object graph bị ép thành contract ra ngoài, không như chi tiết framework tự lo.

📅 Ngày tạo: 2026-03-27 · 🔄 Cập nhật: 2026-04-04 · ⏱️ 5 phút đọc

## 1. DEFINE

Hình dung một response JSON ra ngoài client đang vô tình lộ cả field nội bộ, lazy relation hoặc shape mà team không hề muốn support lâu dài. Serialization bắt đầu nguy hiểm ở khoảnh khắc nó bị xem là việc ObjectMapper sẽ tự lo thay bạn.

Lane `Java Core Libraries Serialization` được mở để biến một đường link từng chết thành một decision point có thể dùng thật trong reading path của `assets/java`.
...
| [`../io-nio/README.md`](../io-nio/README.md) | Khi lane này chưa đủ để mở hết tension | Giữ người đọc ở cùng cụm thay vì nhảy ngẫu nhiên |
