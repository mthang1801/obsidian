...
# Java Core Libraries HTTP Client

> Điểm vào cho nhánh Java Core Libraries HTTP Client, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java Core Libraries HTTP Client`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-http-client-basics-async-requests.md`](01-http-client-basics-async-requests.md) | Article | Seed article của nhánh hiện tại |
...
----------------------------  ----------------------------  ----------------
Java Core Libraries — HTTP C  entry article                  1 article
```
...
| --- | --- | --- |
| [`01-http-client-basics-async-requests.md`](./01-http-client-basics-async-requests.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
