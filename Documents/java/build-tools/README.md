...
> Router cho nhánh Java Build Tools, nơi Gradle, Maven và các lane liên quan được ghép thành một đường học có chủ đích.
...
Riêng với nhánh `Java Build Tools`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`gradle/`](gradle/README.md) | Directory | Router cho nhánh Gradle |
| [`maven/`](maven/README.md) | Directory | Router cho nhánh Maven |
...
----------------------------  ----------------------------  ----------------
Gradle                        entry via README               1 article(s)
Maven                         entry via README               1 article(s)
```
...
| --- | --- | --- |
| [`gradle/`](./gradle/README.md) | Khi muốn đi sâu vào Gradle | Giữ learning path liền mạch |
| [`maven/`](./maven/README.md) | Khi muốn đi sâu vào Maven | Giữ learning path liền mạch |
