...
> Điểm vào cho nhánh Java Build Tools Maven, mở đúng seed article gần nhất để người đọc khóa được mental model trước khi lan sang nhánh khác.
...
Riêng với nhánh `Java Build Tools Maven`, mục tiêu không phải đọc cho đủ mục. Mục tiêu là biết nên vào từ đâu khi symptom, câu hỏi hoặc decision point đã xuất hiện ngay trong công việc thật.
...
| --- | --- | --- |
| [`01-pom-lifecycle-dependency-management.md`](01-pom-lifecycle-dependency-management.md) | Article | Seed article của nhánh hiện tại |
...
----------------------------  ----------------------------  ----------------
Maven — POM, Lifecycle, Depe  entry article                  1 article
```
...
| --- | --- | --- |
| [`01-pom-lifecycle-dependency-management.md`](./01-pom-lifecycle-dependency-management.md) | Khi muốn vào thẳng seed article | Đi nhanh vào khái niệm đang nóng nhất |
