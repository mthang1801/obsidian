...
Hình dung `Drizzle Advanced` xuất hiện ngay lúc bạn cần Drizzle không chỉ “type-safe” mà còn phải rõ boundary giữa TypeScript code và database contract.


Phần advanced của Drizzle không còn là cú pháp. Nó là nơi bạn buộc phải quyết định transaction boundary, query composition và database contract một cách có chủ đích hơn.
...
- Mở hub này khi bạn biết vấn đề nằm trong `Drizzle Advanced`, nhưng chưa rõ nên đọc bài nào trước.
...
| Entry | Vai trò |
| --- | --- |
| [Drizzle Advanced — Transactions, Prepared Statements & Raw SQL](01-transactions-advanced.md) | Điểm vào cho lane `Drizzle Advanced — Transactions, Prepared Statements & Raw SQL` |
| [Drizzle Advanced — Views, Sequences, Dynamic SQL & Patterns](02-views-sequences-dynamic.md) | Điểm vào cho lane `Drizzle Advanced — Views, Sequences, Dynamic SQL & Patterns` |
...
![Drizzle Advanced — Transactions → Views → Dynamic SQL progressive complexity](./images/drizzle-advanced-path.png)
...
> **Ví dụ**: Chọn đúng cụm cần đọc trong `Drizzle Advanced`.
> **Độ phức tạp**: Basic

```yaml
router:
  module: Drizzle Advanced
  rule: "chọn lane theo pain point, không theo tên nghe quen"
  suggested_path:
  - 01-transactions-advanced.md
  - 02-views-sequences-dynamic.md
```
...
| --- | --- | --- | --- |
| Drizzle Advanced — Transactions, Prepared Statements & Raw SQL | Internal | [Drizzle Advanced — Transactions, Prepared Statements & Raw SQL](01-transactions-advanced.md) | Entry point liên quan trực tiếp |
| Drizzle Advanced — Views, Sequences, Dynamic SQL & Patterns | Internal | [Drizzle Advanced — Views, Sequences, Dynamic SQL & Patterns](02-views-sequences-dynamic.md) | Entry point liên quan trực tiếp |
...
| --- | --- | --- | --- |
| Drizzle Advanced — Transactions, Prepared Statements & Raw SQL | Khi pain point khớp lane này | Đi tiếp đúng cụm thay vì đọc rời | [Drizzle Advanced — Transactions, Prepared Statements & Raw SQL](01-transactions-advanced.md) |
| Drizzle Advanced — Views, Sequences, Dynamic SQL & Patterns | Khi pain point khớp lane này | Đi tiếp đúng cụm thay vì đọc rời | [Drizzle Advanced — Views, Sequences, Dynamic SQL & Patterns](02-views-sequences-dynamic.md) |
