...
> Lane cho introduction, setup và mental model gốc của Drizzle ORM.

| Aspect | Detail |
| --- | --- |
| **Concept** | Hub điều hướng cho `Drizzle Overview` |
| **Audience** | Engineer mới bắt đầu với Drizzle |
| **Primary style** | Concept-First router |
| **Entry point** | Mở khi bạn cần hiểu Drizzle là gì và cách nó khác các ORM khác. |
...
Hình dung `Drizzle Overview` xuất hiện ngay lúc bạn cần Drizzle không chỉ “type-safe” mà còn phải rõ boundary giữa TypeScript code và database contract.


Trước khi bàn query nâng cao hay migration, bạn cần chốt một điều rất thực dụng: vì sao Drizzle đáng dùng trong project này và nó đặt boundary ORM ở đâu.
...
- Mở hub này khi bạn biết vấn đề nằm trong `Drizzle Overview`, nhưng chưa rõ nên đọc bài nào trước.
...
| Entry | Vai trò |
| --- | --- |
| [Drizzle ORM — Giới Thiệu & Cài Đặt](01-introduction-setup.md) | Điểm vào cho lane `Drizzle ORM — Giới Thiệu & Cài Đặt` |
...
![Drizzle Architecture — TypeScript Schema → SQL Generation → Database Driver with zero-overhead approach](./images/drizzle-architecture.png)
...
bắt đầu từ pain point hiện tại
  -> Drizzle ORM — Giới Thiệu & Cài Đặt
```
...
> **Ví dụ**: Chọn đúng cụm cần đọc trong `Drizzle Overview`.
> **Độ phức tạp**: Basic

```yaml
router:
  module: Drizzle Overview
...
| --- | --- | --- | --- |
| Drizzle ORM — Giới Thiệu & Cài Đặt | Internal | [Drizzle ORM — Giới Thiệu & Cài Đặt](01-introduction-setup.md) | Entry point liên quan trực tiếp |
...
| --- | --- | --- | --- |
| Drizzle ORM — Giới Thiệu & Cài Đặt | Khi pain point khớp lane này | Đi tiếp đúng cụm thay vì đọc rời | [Drizzle ORM — Giới Thiệu & Cài Đặt](01-introduction-setup.md) |
