...
> Lane cho select/insert/update/delete với mental model SQL-like của Drizzle.

| Aspect | Detail |
| --- | --- |
| **Concept** | Hub điều hướng cho `Drizzle CRUD` |
| **Audience** | Engineer đang chuyển từ SQL thuần hoặc ORM khác sang Drizzle |
| **Primary style** | Concept-First router |
| **Entry point** | Mở khi bạn cần CRUD flows thật thay vì phần giới thiệu. |
...
Hình dung `Drizzle CRUD` xuất hiện ngay lúc bạn cần Drizzle không chỉ “type-safe” mà còn phải rõ boundary giữa TypeScript code và database contract.


Khi Drizzle bắt đầu có giá trị thật, đó là lúc bạn viết query hàng ngày và cần vừa type-safe vừa đủ gần SQL để không mất kiểm soát.
...
- Mở hub này khi bạn biết vấn đề nằm trong `Drizzle CRUD`, nhưng chưa rõ nên đọc bài nào trước.
...
| Entry | Vai trò |
| --- | --- |
| [Drizzle CRUD — Select, Insert, Update, Delete & Joins](01-crud-select-insert-update-delete.md) | Điểm vào cho lane `Drizzle CRUD — Select, Insert, Update, Delete & Joins` |
...
![Drizzle CRUD — SELECT → INSERT → UPDATE → DELETE → JOINs progressive path](./images/drizzle-crud-path.png)
...
> **Ví dụ**: Chọn đúng cụm cần đọc trong `Drizzle CRUD`.
> **Độ phức tạp**: Basic
...
router:
  ...
  suggested_path:
  - 01-crud-select-insert-update-delete.md
```
...
| --- | --- | --- | --- |
| Drizzle CRUD — Select, Insert, Update, Delete & Joins | Internal | [Drizzle CRUD — Select, Insert, Update, Delete & Joins](01-crud-select-insert-update-delete.md) | Entry point liên quan trực tiếp |
...
| --- | --- | --- | --- |
| Drizzle CRUD — Select, Insert, Update, Delete & Joins | Khi pain point khớp lane này | Đi tiếp đúng cụm thay vì đọc rời | [Drizzle CRUD — Select, Insert, Update, Delete & Joins](01-crud-select-insert-update-delete.md) |
