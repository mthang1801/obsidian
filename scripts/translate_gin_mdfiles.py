...
def post_process_vietnamese(text):
    ...
    replacements = [
        ...
        (r'nuốt errors', 'nuốt các error'),
        (r'nuốt', 'nuốt (swallowed)'),
        (r'các lỗi hoảng sợ', 'các lỗi panic'),
...
def main():
    ...
    all_files.sort()
    total = len(all_files)
    print(f"Found {total} Gin markdown files to translate in parallel with dynamic glossary.")
