...
def main():
    ...
    os.system("git checkout -- /home/mvt/mAIvt/Documents/go/orm/")
    ...
    all_files.sort()
    total = len(all_files)
    print(f"Found {total} ORM markdown files to translate in parallel with dynamic glossary.")
    
    with ThreadPoolExecutor(max_workers=8) as executor:
        executor.map(translate_markdown_file, all_files)
        
    print("ALL ORM TRANSLATIONS COMPLETED SUCCESSFULLY!")
